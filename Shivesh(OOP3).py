...
root = Tk()
# connection = sqlite3.connect(host='localhost', user='root', port='3306', password='', database='py_lg_rg_db')
connection = sqlite3.connect('py_lg_rg_db')
c = connection.cursor()
...
username_entry = tk.Entry(login_contentframe, font=('Verdana',16), foreground='#000000')
...
login_button = tk.Button(login_contentframe,text="Login", font=('Verdana',16), 
                         bg='#ffffff',fg='#000', padx=25, pady=10, width=25)
...
confirmpass_label_rg = tk.Label(register_contentframe, text='Re-Password:', 
                                font=('Verdana',14), bg=bgcolor)
phone_label_rg = tk.Label(register_contentframe, text='Date of Birth:', 
                          font=('Verdana',14), bg=bgcolor)
...
register_button = tk.Button(register_contentframe,text="Register", font=('Verdana',16), bg='#2980b9',fg='#000', padx=25, pady=10, width=25)
